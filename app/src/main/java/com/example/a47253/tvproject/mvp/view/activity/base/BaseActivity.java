package com.example.a47253.tvproject.mvp.view.activity.base;
...
import com.example.a47253.tvproject.utils.ColorBar;
...
public abstract class BaseActivity<P extends BasePresenter> extends AppCompatActivity implements IBaseActivity {
    ...
    @BindColor(R.color.background_gradient_start)
